      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gray-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <p className="text-gray-400 text-lg leading-relaxed">
            Manage your collection, organize your books, and keep track of your
            reading journey.
          </p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-linear-to-r from-blue-600 to-blue-700 text-white py-3 px-4 rounded-xl hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all font-medium shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30"
              >
                {loading ? (
